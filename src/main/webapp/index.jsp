...
<div class="container header">
	...
	<div class="span9">
<div class="headerAd">
	<img src="<%=basePath %>/static/image/header.jpg" width="320" height="50" alt="正品保障" title="正品保障"/>
</div>	</div>
...
<div class="container footer">
	<div class="span24">
		<div class="footerAd">
					<img src="<%=basePath %>/static/image/footer.jpg" width="950" height="52" alt="我们的优势" title="我们的优势">
</div>	</div>
	<div class="span24">
		<ul class="bottomNav">
					<li>
